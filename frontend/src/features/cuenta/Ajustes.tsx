    ...
    <div className="mx-auto flex max-w-180 flex-col gap-3 xl:max-w-232 xl:flex-row xl:gap-8">
      ...
      <div className="flex min-w-0 flex-1 flex-col gap-3">
        <header className="mb-1 flex items-center gap-3.5">
          <span
            aria-hidden="true"
            className="flex size-11 shrink-0 items-center justify-center rounded-group bg-linear-to-br from-avatar-from to-avatar-to font-display text-page font-bold text-accent-ink"
          >
